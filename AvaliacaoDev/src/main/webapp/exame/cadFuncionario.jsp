		...
		<div class="container">
			<div class="row mt-5 mb-2">
				<div class="col-sm p-0">
					<s:form action="/filtrarfuExames.action">
			...
			<div class="row">
				<table class="table table-light table-striped align-middle">
					...
					<tbody>
						<s:iterator value="exames" >
							<tr>
								...
								<td>${nome}</td>
								<td class="text-end">
									<s:url action="editarfuExames" var="editar">
									...
									<s:url action="remoFuExames" var="remover">
										<s:param name="exameVo.rowid" value="rowid"></s:param>
									</s:url>
					...
					<tfoot class="table-secondary">
						<tr>
							<td colspan="3">
								<s:url action="novofunExames" var="novo"/>
								...
								<s:url action="realifuncExames" var="realifunc"/>
								
								<a href="${realifunc}" class="btn btn-success">
									<s:text name="label.crud.realifunc"/>
								</a>
							</td>
						</tr>
					</tfoot>				
