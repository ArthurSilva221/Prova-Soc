...
<html>
	<head>
		...
		<title><s:text name="label.titulo.pagina.alteracao.funcionario"/></title>
		<link rel='stylesheet' href='webjars/bootstrap/5.1.3/css/bootstrap.min.css'>
	</head>
	<body class="bg-secondary">

		<div class="container">
			<s:form action="/editrExames.action">

				<div class="card mt-5">
					<div class="card-header">
						<div class="row">
							<div class="col-sm-5">
								<s:url action="realifuncExames" var="todos"/>
								<a href="${todos}" class="btn btn-success" >EXAME REALIZADO</a>
							</div>
							
							<div class="col-sm">
								<h5 class="card-title">ALTERAR EXAME REALIZADO</h5>
							</div>
						</div>
					</div>
					...
					<div class="card-footer">
						<div class="form-row">
							<button class="btn btn-primary col-sm-4 offset-sm-1">ALTERAR</button>
